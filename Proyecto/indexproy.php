...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- <a class="navbar-brand logo-text page-scroll" href="index.html">Proyecto</a> -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>Ofertas de Empleo - PROYECTO</h1>
                            <p class="p-large">Consulta aqui las mejores ofertas de trabajo.</p>
                            <a class="btn-solid-lg page-scroll" href="sign-up.php">Registrarse</a>
                        </div> <!-- end of text-container -->
                    </div> <!-- end of col -->
                    <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <div class="img-wrapper">
                                <img class="img-fluid" src="images/header.png" alt="alternative" width="70%">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2 class="h2-heading">Que es una bolsa de empleo</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">¿Qué es?</h4>
                            <p>Es un cúmulo de oferta y demanda de puestos de trabajo y la bolsa de trabajo ejerce una función de intermediario.</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">¿Qué necesito para aplicar a una oferta?</h4>
                            <p>Para aplicar para una oferta, debes registrarte y enviar tu CV</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Ventajas</h4>
                            <p>Facilidad de acceso a las ofertas de trabajo, cada usuario puede acceder a una gran cantidad de ofertas de trabajo y echar diferentes solicitudes desde un simple ordenador.</p>
                        </div>
                    </div>
                    <!-- end of card -->
