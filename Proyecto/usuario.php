...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Modo Usuario (Página Principal)</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        <h3>¿Qué puedo hacer como Usuario?</h3>
                        <p>Como Usuario puedes aplicar para las ofertas de trabajo que desees, siempre y cuando envies tu Curriculum Vitae. Disfruta de las siguientes opciones:</p>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="list-unstyled li-space-lg indent">
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Enviar Curriculum Vitae.</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Ver ofertas de trabajo, asi como consultar las tuyas y ver su estado, ya sea activo o inactivo.</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Editar tu perfil de Usuario</div>
                                    </li>
                                </ul>
                            </div> <!-- end of col -->
                        </div> <!-- end of row -->
