...
$pdf->Cell(40,10,utf8_decode('Lista de Reclutadores'));
...
$registro=mysqli_query($conexion,"SELECT * FROM Usuarios WHERE TipoUsu='Reclutador';") or die("Problema en el select: ".mysqli_error($conexion)); 
