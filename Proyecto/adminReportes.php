...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Modo Administrador (Reportes)</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action=ReporteUsuarios.php method="post">
                        <h3>DESCARGAR LISTA DE USUARIOS</h3>
                        <input type="submit" name="enviar">
                     </form>
                     <br>
                     <form action=ReporteReclutadores.php method="post">
                        <h3>DESCARGAR LISTA DE RECLUTADORES</h3>
                        <input type="submit" name="enviar">
                     </form>
                     <br>
                     <form action=ReporteAdministradores.php method="post">
                        <h3>DESCARGAR LISTA DE ADMINISTRADORES</h3>
                        <input type="submit" name="enviar">
                     </form>
                     <br>
                     <form action=ReporteEmpresas.php method="post">
                        <h3>DESCARGAR LISTA DE EMPRESAS</h3>
                        <input type="submit" name="enviar">
                     </form>
                     <br>
                     <form action=ReporteOfertas.php method="post">
                        <h3>DESCARGAR LISTA DE OFERTAS</h3>
                        <input type="submit" name="enviar">
                     </form>
