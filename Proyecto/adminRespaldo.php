...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Modo Administrador (Respaldo de la base de datos)</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        <h1>Guardar cambios en la base de datos (Realizar Respaldo)</h1>
                        <input type="submit" name="enviar">
                     </form>
                     
                     <?php
                         include("config.php");
                         $mysqlExportPath ='RESPALDO_DATABASE.sql';
                        ...
                        if($conexion){
                            ...
                            $command='mysqldump --opt -h' .$server .' -u' .$db_user .' -p' .$db_pass .' ' .$database .' > ' .$mysqlExportPath;
                            exec($command,$output=array(),$worked);
                            /*
                            switch($worked){
                                case 0:
                                echo 'La base de datos <b>' .$database .'</b> se ha almacenado correctamente en la siguiente ruta '.getcwd().'/' .$mysqlExportPath .'</b>';
                                break;
                                case 1:
                                echo 'Se ha producido un error al exportar <b>' .$database .'</b> a '.getcwd().'/' .$mysqlExportPath .'</b>';
                                break;
                                case 2:
                                echo 'Se ha producido un error de exportación, compruebe la siguiente información: <br/><br/><table><tr><td>Nombre de la base de datos:</td><td><b>' .$database .'</b></td></tr><tr><td>Nombre de usuario MySQL:</td><td><b>' .$db_user .'</b></td></tr><tr><td>Contraseña MySQL:</td><td><b>NOTSHOWN</b></td></tr><tr><td>Nombre de host MySQL:</td><td><b>' .$mysqlHostName .'</b></td></tr></table>';
                                break;
                                }
                                */
                            }
                            echo "<br><h2>Descarga tu base de datos ";
                            echo "<a href='RESPALDO_DATABASE.sql' download='RespaldoBD.sql'>aqui</h2></a>";
