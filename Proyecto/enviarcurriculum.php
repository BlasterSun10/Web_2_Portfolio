                ...
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        ...
                        if($conexion){
                            ...
                            $query = "SELECT * FROM Curriculum INNER JOIN Usuarios ON Usuarios.IDUsu=Curriculum.IDUsuario WHERE Usuarios.IDUsu='$idusucur';";
                            $registros = mysqli_query($conexion, $query) or die ("Problemas en la query ".mysqli_error());
                            
                            echo $query;
                            
                            echo "<table border = '1' align='center' bordercolor='blue' cellspacing='0'><tr bgcolor='#05FFA4'><th>ID Curriculum</th><th>Nombre</th><th>Correo Electronico</th><th>Fecha de nacimiento</th><th>Telefono</th><th>Descripción</th><th>Trabajo 1</th><th>Trabajo 2</th><th>Trabajo 3</th><th>Idioma 1</th><th>Idioma 2</th><th>Nivel Académico</th><th>Trabajo Actual</th><th>ID Usuario</th></tr>";
                
                            $tupla = mysqli_fetch_array($registros);
                                echo "<tr bgcolor='#FFE594'><td>".$tupla['IDcurri']."</td>";
                                $idcurri=$tupla['IDcurri'];
                                echo "<td>".$tupla['Nombre']."</td>";
                                echo "<td>".$tupla['CorreoEle']."</td>";
                                echo "<td>".$tupla['FechaNaci']."</td>";
                                echo "<td>".$tupla['Telefono']."</td>";
                                echo "<td>".$tupla['Descripcion']."</td>";
                                echo "<td>".$tupla['Trabajo1']."</td>";
                                echo "<td>".$tupla['Trabajo2']."</td>";
                                echo "<td>".$tupla['Trabajo3']."</td>";
                                echo "<td>".$tupla['IdiomaExtra1']."</td>";
                                echo "<td>".$tupla['IdiomaExtra2']."</td>";
                                echo "<td>".$tupla['NivelAcademico']."</td>";
                                echo "<td>".$tupla['TrabajoAct']."</td>";
                                echo "<td>".$tupla['IDUsuario']."</td><tr>";
                    ...
                    <?php
                        ...
                        if($conexion){
                            ...
                            echo "ID curriculum <br>";
                            echo $idcurri;
                            if(isset($_POST['enviardos'])){
                                $query="UPDATE Curriculum SET ".$_POST['opcion']."='".$_POST['texto']."' WHERE IDUsuario='".$idcurri."';";
                                echo "La consulta generada es: <br>".$query;
                                if(mysqli_query($conexion,$query))/* echo "<br>datos guardados <br>"*/;
                            }
                        }
                        ...
                        <select name="opcion">
                           ...
                           <option value="CorreoEle">Correo Electrónico</option>
                           <option value="FechaNaci">Fecha de nacimiento (AAAA-MM-DD)</option>
                           <option value="Telefono">Teléfono</option>
                           <option value="Descripcion">Descripción</option>
                           <option value="Trabajo1">Trabajo 1</option>
                           <option value="Trabajo2">Trabajo 2</option>
                           <option value="Trabajo3">Trabajo 3</option>
                           <option value="IdiomaExtra1">Idioma 1</option>
                           <option value="IdiomaExtra2">Idioma 2</option>
                           <option value="NivelAcademico">Nivel Académico</option>
                           <option value="TrabajoAct">Trabajo Actual</option>
                        </select>
