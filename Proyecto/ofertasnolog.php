...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="indexproy.php#header">Inicio</a>
                    </li>
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>OFERTAS DE EMPLEO DISPONIBLES</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        ...
                        if($conexion){
                            ...
                            echo "<table border = '1'><tr><th>Nombre de la Oferta</th><th>Puesto</th><th>Puestos Disponibles</th><th>Descripción</th><th>Fecha de Inicio</th><th>Fecha de Finalización</th><th>Salario</th></tr>";
                    ...
                    <?php
                        ...
                        if($conexion){
                            ...
                            $registros = mysqli_query($conexion, $query) or die ("Problemas en la query ".mysqli_error());
                            while($tuplados = mysqli_fetch_array($registros)){
                                echo "<img src=".$tuplados[URLlogEmp]." width='25%'>";
                            }
                        }
