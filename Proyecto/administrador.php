...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Modo Administrador (Página Principal)</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-container">
                        <h3>¿Qué puedo hacer como Administrador?</h3>
                        <p>Como Administrador puedes administrar el ABC empresas que conforman la bolsa de trabajo, asi como a los reclutadores y socilitantes</p>
                        <div class="row">
                            <div class="col-md-6">
                                <ul class="list-unstyled li-space-lg indent">
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Consultar Empresas</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Editar y agregar Empresas</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Consultar Reclutadores</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Asociar Reclutadores a Empresas</div>
                                    </li>
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                    ...
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Realizar respaldo de la base de datos</div>
                                    </li>
                                    
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Descargar la base de datos</div>
                                    </li>
                                    
                                    <li class="media">
                                        <i class="fas fa-square"></i>
                                        <div class="media-body">Descargar los reportes de la base de datos</div>
                                    </li>
                                </ul>
                            </div> <!-- end of col -->
